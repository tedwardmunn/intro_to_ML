...
set(gca, 'XTickLabel',  {'1', '2', '3', '4', '5', '10', '20', '30', '50', '100'})
...
%<The code is incomplete; add one line of code here! >
fprintf('The final accuracy on test set is yyy %d, which is obtained with k = %xxx, where k is selected using a validation set.',acc, best_k);
